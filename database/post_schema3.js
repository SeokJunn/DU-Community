...
SchemaObj.createSchema = function(mongoose) {
	...
	// 글 스키마 정의
	var PostSchema3 = mongoose.Schema({
	...
	PostSchema3.path('title').required(true, '글 제목을 입력하셔야 합니다.');
	PostSchema3.path('contents').required(true, '글 내용을 입력하셔야 합니다.');
