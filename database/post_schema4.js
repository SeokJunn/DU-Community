...
SchemaObj.createSchema = function(mongoose) {
	...
	// 글 스키마 정의
	var PostSchema4 = mongoose.Schema({
	...
	PostSchema4.path('title').required(true, '글 제목을 입력하셔야 합니다.');
	PostSchema4.path('contents').required(true, '글 내용을 입력하셔야 합니다.');
	...
	console.log('PostSchema4 정의함.');

	return PostSchema4;
};

// module.exports에 PostSchema2 객체 직접 할당
